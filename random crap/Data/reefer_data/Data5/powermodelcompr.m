...
>>>>>>> b23a8c74d115b53ba0ef0971a8ba3903f809eb2b


%%
<<<<<<< HEAD

err = immse(power,Watt)/length(Watt)
%err2 = immse(power2,Watt)/length(Watt)
=======
err = immse(Freqconvert.Udc.*Freqconvert.Idc,Watt)/length(Watt) %MSE for measured power vs calculated power
